...
<head>
    ...
    <title><?php echo e(config('app.name', 'Nice Admin')); ?></title>

    <!-- Favicon -->
    <link rel="icon" type="image/png" href="<?php echo e(asset('backend/assets/images/favicon.png')); ?>">

    <!-- Bootstrap CSS -->
    <link href="<?php echo e(asset('backend/assets/libs/bootstrap/css/bootstrap.min.css')); ?>" rel="stylesheet">
    <!-- Font Awesome -->
    <link href="<?php echo e(asset('backend/assets/libs/font-awesome/css/all.min.css')); ?>" rel="stylesheet">
    <!-- Custom CSS -->
...
<body>
            ...
            <div class="container-fluid">
                <nav class="navbar navbar-expand-md navbar-light">
                    <a class="navbar-brand" href="#">
                        <img src="<?php echo e(asset('backend/assets/images/logo-icon.png')); ?>" alt="Logo" width="30">
    ...
    <script src="<?php echo e(asset('backend/assets/libs/bootstrap/js/bootstrap.min.js')); ?>"></script>
    <script src="<?php echo e(asset('backend/assets/js/custom.min.js')); ?>"></script>
</body>
</html><?php /**PATH D:\Projek\Projek\resources\views/backend/layouts/template.blade.php ENDPATH**/ ?>