          ...
          <ul class="navbar-nav ms-auto">
            <li class="nav-item dropdown user-menu">
              <a href="#" class="nav-link dropdown-toggle" data-bs-toggle="dropdown">
                <img src="<?php echo e(asset('backend/dist/assets/img/user2-160x160.jpg')); ?>" class="user-image rounded-circle shadow" alt="User Image" />
                <span class="d-none d-md-inline">Admin System</span>
              </a>
              <ul class="dropdown-menu dropdown-menu-lg dropdown-menu-end">
                <li class="user-header text-bg-primary">
                  <img src="<?php echo e(asset('backend/dist/assets/img/user2-160x160.jpg')); ?>" class="rounded-circle shadow" alt="User Image" />
                  <p>Admin System - Web Developer</p>
                </li>
                <li class="user-footer">
                  <a href="#" class="btn btn-default btn-flat">Profile</a>
                  
                  <a href="<?php echo e(route('logout')); ?>" class="btn btn-default btn-flat float-end" 
      ...
      <aside class="app-sidebar bg-body-secondary shadow" data-bs-theme="dark">
        <div class="sidebar-brand">
          <a href="#" class="brand-link">
            <img src="<?php echo e(asset('backend/dist/assets/img/AdminLTELogo.png')); ?>" alt="AdminLTE Logo" class="brand-image opacity-75 shadow" />
        ...
        <div class="sidebar-wrapper">
          <nav class="mt-2">
            <ul class="nav sidebar-menu flex-column" data-lte-toggle="treeview" role="navigation" data-accordion="false">
              ...
              <li class="nav-item">
                <a href="<?php echo e(route('backend.dashboard')); ?>" class="nav-link active">
...
</html><?php /**PATH C:\Projek\Projek\resources\views/backend/layouts/template.blade.php ENDPATH**/ ?>